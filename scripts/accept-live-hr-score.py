...
out = root / 'output' / ('hr-score-acceptance-' + str(time.time_ns()))
out.mkdir(parents=True)
with sqlite3.connect(source/'control.sqlite') as src, sqlite3.connect(out/'score.sqlite') as dst:
    src.backup(dst)
fixture = json.loads((source/'live-fixture-private.json').read_text())
assert fixture['sessionId'] == '0b026a89-a7d9-472b-84bf-981182a041ad'
