...
1b. 岗位名称为"(未提供)"时，题目中用"你应聘的岗位"或直接描述工作内容，严禁用公司名（如"数君""数君科技"）代替岗位名。
1c. 像真人 HR 一样得体提问：严禁把候选人的离职状态、在职状态、空窗期等求职状态当作提问前提或写在题面里（如"你目前离职正在找工作"这类表述）。考察动机与稳定性时，直接问职业选择、岗位理解和未来规划本身。
